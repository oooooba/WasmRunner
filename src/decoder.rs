...
fn decode_instr<R: Read>(reader: &mut R) -> Result<Instr, DecodeError> {
    ...
    match b {
        ...
        0x73 => Ok(Instr::new(BinopI32(BinopKind::Xor))),
        0x74 => Ok(Instr::new(BinopI32(BinopKind::Shl))),
        0x75 => Ok(Instr::new(BinopI32(BinopKind::SShr))),
        0x76 => Ok(Instr::new(BinopI32(BinopKind::UShr))),
        ...
        0x7B => Ok(Instr::new(UnopI64(UnopKind::Popcnt))),
