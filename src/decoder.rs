...
fn decode_instr<R: Read>(reader: &mut R) -> Result<Instr, DecodeError> {
    ...
    match b {
        ...
        0x6D => Ok(Instr::new(BinopI32(IBinopKind::SDiv))),
        0x6E => Ok(Instr::new(BinopI32(IBinopKind::UDiv))),
        0x6F => Ok(Instr::new(BinopI32(IBinopKind::SRem))),
        0x70 => Ok(Instr::new(BinopI32(IBinopKind::URem))),
        ...
        0x75 => Ok(Instr::new(BinopI32(IBinopKind::SShr))),
        0x76 => Ok(Instr::new(BinopI32(IBinopKind::UShr))),
